...
export default function IngredientPage() {
    ...
    return (
        <div>
            ...
            <Dialog open={dialogOpen} onClose={handleClickClose} maxWidth='md' fullWidth={true} fullScreen={isMobile}>
                <ModalBody handleClose={handleClickClose} index={modalIndex} />
            </Dialog>
            <Grid container>
                <Grid item xs={6} md={3}>
                ...
                <Grid item xs={6} md={3}>
                    <Paper className={classes.paper} onClick={() => handleClickOpen(0)} square>
                ...
                <Grid item xs={6} md={3}>
                    <Paper className={classes.paper} onClick={() => handleClickOpen(1)} square>
                ...
                <Grid item xs={6} md={3}>
                    <Paper className={classes.paper} onClick={() => handleClickOpen(2)} square>
                ...
                <Grid item xs={6} md={3}>
                    <Paper className={classes.paper} onClick={() => handleClickOpen(3)} square>
